...
template <typename T>
void copyCol(NTable<T> &des, const NTable<T> &src);
template <typename T>
void copyCol(NTable<T> &des, const NTable<T> &src, int index);
template <typename T>
void copyCol(NTable<T> &des, const NTable<T> &src, const QVector<int> &index);
template <typename T>
void copyRow(NTable<T> &des, const NTable<T> &src);
template <typename T>
void copyRow(NTable<T> &des, const NTable<T> &src, int index);
template <typename T>
void copyRow(NTable<T> &des, const NTable<T> &src, const QVector<int> &index);
template <typename T, typename U>
void select(NTable<T> &des, const NTable<U> &src);
template <typename T, typename U>
void selectCol(NTable<T> &des, const NTable<U> &src);
template <typename T, typename U>
void selectCol(NTable<T> &des, const NTable<U> &src, int index);
template <typename T, typename U>
void selectCol(NTable<T> &des, const NTable<U> &src, const QVector<int> &index);
template <typename T, typename U>
void selectRow(NTable<T> &des, const NTable<U> &src);
template <typename T, typename U>
void selectRow(NTable<T> &des, const NTable<U> &src, int index);
template <typename T, typename U>
void selectRow(NTable<T> &des, const NTable<U> &src, const QVector<int> &index);
}
...
public:
    ...
    template <typename T>
    friend void NTableFunc::copyCol(NTable<T> &des, const NTable<T> &src);
    template <typename T>
    friend void NTableFunc::copyCol(NTable<T> &des, const NTable<T> &src, int index);
    template <typename T>
    friend void NTableFunc::copyCol(NTable<T> &des, const NTable<T> &src, const QVector<int> &index);
    template <typename T>
    friend void NTableFunc::copyRow(NTable<T> &des, const NTable<T> &src);
    template <typename T>
    friend void NTableFunc::copyRow(NTable<T> &des, const NTable<T> &src, int index);
    template <typename T>
    friend void NTableFunc::copyRow(NTable<T> &des, const NTable<T> &src, const QVector<int> &index);
    template <typename T, typename U>
    friend void NTableFunc::select(NTable<T> &des, const NTable<U> &src);
    template <typename T, typename U>
    friend void NTableFunc::selectCol(NTable<T> &des, const NTable<U> &src);
    template <typename T, typename U>
    friend void NTableFunc::selectCol(NTable<T> &des, const NTable<U> &src, int index);
    template <typename T, typename U>
    friend void NTableFunc::selectCol(NTable<T> &des, const NTable<U> &src, const QVector<int> &index);
    template <typename T, typename U>
    friend void NTableFunc::selectRow(NTable<T> &des, const NTable<U> &src);
    template <typename T, typename U>
    friend void NTableFunc::selectRow(NTable<T> &des, const NTable<U> &src, int index);
    template <typename T, typename U>
    friend void NTableFunc::selectRow(NTable<T> &des, const NTable<U> &src, const QVector<int> &index);
};
...
void copyRow(NTable<T> &des, const NTable<T> &src, int index){
    des.setData(src.data);
    des.rowIndex.clear();
    des.rowIndex.append(src.rowIndex[index]);
}
